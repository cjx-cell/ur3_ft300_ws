...
def resolve_delta_timestamps(
    ...
    """
    delta_timestamps = {}
    feature_delta_indices = getattr(cfg, "feature_delta_indices", {}) or {}
    for key in ds_meta.features:
        if key in feature_delta_indices:
            delta_timestamps[key] = [i / ds_meta.fps for i in feature_delta_indices[key]]
