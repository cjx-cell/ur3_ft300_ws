...
SOURCE_CONFIG=$WS_DIR/outputs/train/act_workspace50_v10_official_20k/checkpoints/020000/pretrained_model/train_config.json
RUN_TAG=$(date +%Y%m%d_%H%M%S)
OUTPUT_DIR=${ACT_OUTPUT_DIR:-$WS_DIR/outputs/train/act_workspace50_global_stats_20k_$RUN_TAG}
LOG_FILE=${ACT_LOG_FILE:-$WS_DIR/artifacts/act_workspace50_global_stats_20k_$RUN_TAG.log}
