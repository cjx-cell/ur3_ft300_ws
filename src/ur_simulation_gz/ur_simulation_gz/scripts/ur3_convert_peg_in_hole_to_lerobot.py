...
def find_episodes(input_dir):
    """Scan all *_episode_*/data.npz files."""
    episodes = []
...
def main():
    ...
    parser.add_argument("--source_fps", type=int, default=50,
                        help="Source recording frame rate (default 50Hz, for downsampling)")
    ...
    local_dir = args.output_dir or os.path.expanduser(
        "~/ur3_ft300_ws/ai-models/ur3_peg_in_hole_lerobot")
